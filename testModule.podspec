...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "cuiyun"
  # s.authors            = { "cuiyun" => "675162379@qq.com" }
  # s.social_media_url   = "http://twitter.com/cuiyun"
  ...
  s.source       = { :git => "https://github.com/Cuiyun/testModuleDEV.git", :tag => "#{s.version}" }
